...
#Set target position
echo "Enter target relative position (In absolute, 0 is full extended, 240,000 is bent):"
read target
./canopencomm [1] 2 write 0x607A 0 i32 $target
echo "Target relative position is:"
./canopencomm [1] 2 read 0x607A 0 i32
...
#move knee
./canopencomm [1] 2 write 0x6040 0 i16 111
./canopencomm [1] 2 write 0x6040 0 i16 127
