...
void sitStand(){
    ...
    getPos(1,positionMesNode1);
    getPos(2,positionMesNode2);
    getPos(3,positionMesNode3);
    getPos(4,positionMesNode4);
    ...
    while(1){
        button1Status=getButton(1);
        button2Status=getButton(2);
        button3Status=getButton(3);
